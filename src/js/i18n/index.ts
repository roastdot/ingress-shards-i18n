...
const dictionaries: Record<string, Record<string, string>> = {
  'en-GB': {
    ...
    'map.animation_play': 'Play shard animation',
    'map.animation_pause': 'Pause shard animation',
    'map.animation_loop_enable': 'Loop shard animation',
    'map.animation_loop_disable': 'Stop looping shard animation',
    'map.animation_speed': 'Animation speed: {speed}×',
    'map.animation_select_link': 'Choose a link to animate',
    'map.animation_all_links': 'Animate all links',
  ...
  'zh-CN': {
    ...
    'map.animation_play': '播放碎片动画',
    'map.animation_pause': '暂停碎片动画',
    'map.animation_loop_enable': '循环播放碎片动画',
    'map.animation_loop_disable': '停止循环播放碎片动画',
    'map.animation_speed': '动画速度：{speed}×',
    'map.animation_select_link': '选择要播放动画的连线',
    'map.animation_all_links': '播放所有连线的动画',
  ...
  'zh-HK': {
    ...
    'map.animation_play': '播放碎片動畫',
    'map.animation_pause': '暫停碎片動畫',
    'map.animation_loop_enable': '循環播放碎片動畫',
    'map.animation_loop_disable': '停止循環播放碎片動畫',
    'map.animation_speed': '動畫速度：{speed}×',
    'map.animation_select_link': '選擇要播放動畫的連線',
    'map.animation_all_links': '播放所有連線的動畫',
